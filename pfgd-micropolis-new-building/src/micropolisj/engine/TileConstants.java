...
public class TileConstants
{
	...
	static final char NEW_BUILDING = 972; //Tile id for the NEW_BUILDING tile. This is the id of the center of the tile as listed in tiles.rc
	public static final char LAST_TILE = 985;
